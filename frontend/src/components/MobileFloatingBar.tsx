...
import { ClipboardClock, Phone, UserRoundPlus, Video } from "lucide-react";
...
export default function MobileFloatingBar() {
  ...
  return (
    <aside
      ...
      className="fixed bottom-5 inset-x-0 z-50 flex flex-col items-end px-4 pointer-events-none lg:hidden"
    >
      <div className="w-full max-w-[360px] mx-auto flex flex-col items-end gap-2.5">
        <div
        ...
        >
          <div className="rounded-full bg-white/90 backdrop-blur-xl px-4 py-1.5 text-[11px] font-medium tracking-wide text-neutral-800 shadow-[0_8px_24px_rgba(0,0,0,0.12)] border border-white/60">
            Hey! lets connect.
          </div>
        </div>
        ...
        <div className="pointer-events-auto w-full flex items-center justify-between rounded-[32px] bg-white/80 backdrop-blur-2xl px-2.5 py-2 shadow-[0_20px_50px_rgba(0,0,0,0.18),0_1px_1px_rgba(255,255,255,0.8)_inset] border border-white/50">
          <div className="flex items-center gap-1 sm:gap-1.5 pl-1">
            <Link
              ...
              aria-label="Call Us"
              className="flex items-center justify-center w-10 h-10 rounded-full text-neutral-800 hover:bg-black/5 active:scale-90 transition-all duration-200"
            >
            ...
            <Link
              href="/works"
              className="flex items-center justify-center h-9 px-3.5 rounded-full bg-black/[0.06] hover:bg-black/[0.09] active:scale-95 transition-all duration-200"
            >
          ...
          <Link
            ...
            className="flex items-center justify-center h-11 px-8 rounded-full bg-gradient-to-b from-neutral-800/95 via-neutral-900/95 to-black/95 backdrop-blur-md text-white shadow-[0_4px_18px_rgba(0,0,0,0.28),0_1px_0_rgba(255,255,255,0.15)_inset] active:scale-95 transition-all duration-200 hover:border-white/20"
          >
            <svg
              width="20"
              height="20"
